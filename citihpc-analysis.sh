...
#echo -e "${red} Server Swap:$server_swap ${NC}"
if [ $server_swap -eq 0 ]
then 
...
#star_ibm=`zgrep -A9 "%idle" $ALLDYNAMIC | grep "Average:" | awk '{print $11}'`
...
#star_hp=`zgrep -A13 "%idle" $ALLDYNAMIC | grep "Average:" | awk '{print $8}'`
